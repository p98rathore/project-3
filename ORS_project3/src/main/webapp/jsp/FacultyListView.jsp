...
<%
      ...
      <%=HTMLUtility.getList("subject", String.valueOf(dto.getSubjectId()), slist) %>
								</div>
							</div>
						...
						<tbody>
							...
							<%
									SimpleDateFormat sdf = new SimpleDateFormat("dd/MM/yyyy");
											...
											sd=sm.findByPK(dto.getSubjectId());
								%>
						       ...
						       <td class="text-center"><%=cd.getName()%></td>
								...
								<td class="text-center"><a href="FacultyCtl?id=<%=dto.getId()%>"><i
