						...
						<form class="form" method="post" action="<%=ORSView.COURSE_CTL%>">
							...
							<div class="form-group">
								...
								<div class="input-group">
									...
									String list=HTMLUtility.getList("duration", dto.getDuration(), map);
								...
								<div class="input-group">
									...
									<input type="text" class="form-control col-lg-12"
										placeholder=" Enter descrption" name="description"
								...
								<button class="gradient-button btn-success btn-round" name="operation"
										type="submit" value="<%=CourseCtl.OP_UPDATE%>">upate</button>
								...
								<%}else{ %>
								<button class="gradient-button btn-success btn-round" name="operation"
										type="submit" value="<%=CourseCtl.OP_SAVE%>">Save</button>
