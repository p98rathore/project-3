...
List clist =(List) request.getAttribute("collegeList");
				...
				<input type="hidden" name="pageNo" value="<%=pageNo%>"> <input
					...
					<label><strong >College Name<span style="color:red ">*</span></strong></label>
								<div class="input-group">
									...
									<%=HTMLUtility.getList("collegeId", String.valueOf(dto.getId()), clist) %>
								</div>
							</div>
							&nbsp;
					...
					<label><strong >City<span style="color:red ">*</span></strong></label>
								<div class="input-group">
									...
									<input type="text" name="city" class="form-control text-grey" placeholder="enter city" value="<%=ServletUtility.getParameter("city", request)%>">
								</div>
							</div>
					...
					<table class="table table-striped table-hover bg-light">
						...
						<tbody>
							<tr>
								...
								<td class="text-center"><%=dto.getCity()%></td>
								<td class="text-center"><%=dto.getState()%> </td>
								<td class="text-center"><%=dto.getPhoneNo()%></td>
								<td class="text-center"> <button class="btn btn-link text-primary " type="submit" name="operation" value="<%=CollegeListCtl.OP_DELETE%>">
										<i class="fa fa-trash" aria-hidden="true"></i></button></td>
								<td class="text-center"><a href="CollegeCtl?id=<%=dto.getId()%>"><i
