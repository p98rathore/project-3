							...
							<div class="form-group">
								...
								<div class="input-group">
									 <div class="input-group-prepend">
										...
										<%=HTMLUtility.getList("courseId", String.valueOf(dto.getCourseId()), list) %>
			</div>
			<span class="text-danger pt-3">
								...
								<button class="gradient-button btn-success btn-round" name="operation"
										type="submit" value="<%=SubjectCtl.OP_UPDATE%>">upate</button>
								...
								<%}else{ %>
								<button class="gradient-button btn-success btn-round" name="operation"
										type="submit" value="<%=SubjectCtl.OP_SAVE%>">Save</button>
