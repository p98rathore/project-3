				...
				<input type="hidden" name="pageNo" value="<%=pageNo%>"> <input
					...
					<label><strong>Course Name<span style="color:red ">*</span></strong></label>
								<div class="input-group">
									...
									<%=HTMLUtility.getList("courseId", String.valueOf(dto.getId()), cList) %>
								</div>
							</div>
					...
					<table class="table table-striped table-hover bg-light">
						...
						<tbody>
							<tr>
								...
								<td class="text-center"><%=dto.getDuration()%></td>
								<td class="text-center"><%=dto.getDescription()%></td>
								
								<td class="text-center"> <button class="btn btn-link text-primary " type="submit" name="operation" value="<%=CourseListCtl.OP_DELETE%>" >
										<i class="fa fa-trash" aria-hidden="true"></i></button></td>
								<td class="text-center"><a href="CourseCtl?id=<%=dto.getId()%>"><i
