...
<%
				...
				<input type="hidden" name="pageNo" value="<%=pageNo%>"> <input
					...
					<label><strong >Role Name<span style="color:red ">*</span></strong></label>
							...
							&nbsp;
					<div class="form-group">
					<label><strong>User Name<span style="color:red ">*</span></strong></label>
								<div class="input-group">
									<div class="input-group-prepend">
										<span class="input-group-text"> <i
											class="fa fa-search-plus"></i>
							...
							&nbsp;
					<div class="form-group">
					<label style="text-align: center"><strong>Email<span style="color:red ">*</span></strong></label>
								<div class="input-group">
									<div class="input-group-prepend">
										<span class="input-group-text"> <i
											class="fa fa-search-plus"></i>
					...
					<table class="table table-striped table-hover bg-light">
						...
						<%
							while (it.hasNext()) {
									...
									dto1=model.findByPK(dto.getRoleId());
						...
						<tbody>
							<tr>
								<td><input type="checkbox" class="checkbox" name="ids" 
									value="<%=dto.getId()%>  <% if ( userDTO.getId() == dto.getId() || dto.getRoleId() == RoleDTO.ADMIN) {%>
									<%="disabled"%> onclick="return false;" <%}%>"></td>
								...
								<td class="text-center"> <button class="btn btn-link text-primary " type="submit" name="operation" value="<%=UserListCtl.OP_DELETE%>" <%if (userDTO.getId() == dto.getId() || dto.getRoleId() == RoleDTO.ADMIN) {%>
									<%="disabled"%> <%}%>>
										<i class="fa fa-trash" aria-hidden="true"></i></button></td>
								<td class="text-center"><a href="UserCtl?id=<%=dto.getId()%>" <%if (userDTO.getId() == dto.getId() || dto.getRoleId() == RoleDTO.ADMIN) {%>
