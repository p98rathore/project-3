					...
					<table class="table table-striped table-hover bg-light">
						...
						<tbody>
							<tr>
								...
								<td class="text-center"> <button class="btn btn-link text-primary " type="submit" name="operation" value="<%=RoleListCtl.OP_DELETE%>">
										<i class="fa fa-trash" aria-hidden="true"></i></button></td>
								<td class="text-center"><a href="RoleCtl?id=<%=dto.getId()%>"><i
