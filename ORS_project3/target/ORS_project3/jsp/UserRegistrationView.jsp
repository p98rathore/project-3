					...
					<div class="card card-login" style="margin-bottom: 20px" >
						<form class="form" method="post" action="<%=ORSView.USER_REGISTRATION_CTL%>">
							<div class="card-header card-header-primary text-center" style="background-color: transparent;">
								<h4 class="card-title"><font>User Registration</font></h4>
							</div>
							<%
							...
							<div class="row d-flex justify-content-center">
								<button class="gradient-button btn-success btn-round"
									name="operation" type="submit" value="<%=LoginCtl.OP_SIGN_UP%>">
									SignUp <span><i class="fa fa-add" aria-hidden="true"></i>
									</span>
									</button>
									<button class="gradient-button btn-warning btn-round"
									name="operation" type="submit" value="<%=LoginCtl.OP_RESET%>">
									reset<span><i class="fa fa-reset" aria-hidden="true"></i>
									</span>
								</button>
							</div>
