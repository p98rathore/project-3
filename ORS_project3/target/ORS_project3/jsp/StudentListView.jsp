...
<%@page import="in.co.rays.model.CollegeModelHibImpl"%>
<%@page import="in.co.rays.model.CollegeModelInt"%>
...
<%
				...
				<input type="hidden" name="pageNo" value="<%=pageNo%>"> <input
					...
					<label><strong >First Name<span style="color:red ">*</span></strong></label>
								<div class="input-group">
									...
									<input type="text" name="firstName" class="form-control text-grey" placeholder="enter First Name" value="<%=ServletUtility.getParameter("firstName", request)%>">
								</div>
							</div>
							&nbsp;
       ...
       <input type="text" name="lastName" class="form-control text-grey" placeholder="enter LastNAme" value="<%=ServletUtility.getParameter("lastName", request)%>">
								</div>
							</div>
							&nbsp;
       ...
       <input type="text" name="email" class="form-control text-grey" placeholder="enter Email" value="<%=ServletUtility.getParameter("email", request)%>">
								</div>
							</div>
								&nbsp;
							
						<div class="form-group">
					<label><strong>college<span style="color:red ">*</span></strong></label>
								<div class="input-group">
									<div class="input-group-prepend">
										<span class="input-group-text"> <i
											class="fa fa-search-plus"></i>
      ...
      <%=HTMLUtility.getList("college", String.valueOf(dto.getCollegeID()), clist) %>
								</div>
							</div>
					...
					<table class="table table-striped table-hover bg-light">
						<thead class="bg-dark text-white">
							<tr>
								...
								<th scope="col" class="text-center">MobileNo</th>
						...
						<tbody>
							<tr>
								...
								<td class="text-center"><%=dto.getFirstName()+"  "+dto.getLastName()%></td>
								<td class="text-center"><%=dto.getGender()%> </td>
							<%
									SimpleDateFormat sdf = new SimpleDateFormat("dd/MM/yyyy");
											String date = sdf.format(dto.getDob());
											CollegeModelInt cm= new CollegeModelHibImpl();
											CollegeDTO cd= new CollegeDTO();
											cd=cm.findByPK(dto.getCollegeID());
						       ...
						       <td class="text-center"><%=cd.getName()%></td>
								...
								<td class="text-center"><a href="StudentCtl?id=<%=dto.getId()%>"><i
